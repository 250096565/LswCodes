...
namespace StudyABP.Tests
{
    public abstract class StudyABPTestBase : AbpIntegratedTestBase
    {
        protected StudyABPTestBase()
        {
            //Seed initial data
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<StudyABPApplicationModule>();
            modules.Add<StudyABPDataModule>();
        }

        public void UsingDbContext(Action<StudyABPDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<StudyABPDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<StudyABPDbContext, T> func)
        {
            T result;
